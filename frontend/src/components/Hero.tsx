...
>
  ...
  <span className="absolute inset-0 bg-white/20 translate-x-[-150%] skew-x-12 
...
<div className="relative animate-slide-in-right">
  <div className="relative group rounded-2xl overflow-hidden shadow-2xl">
    ...
    <div className="absolute inset-0 bg-gradient-to-tr from-black/20 via-transparent to-black/10 opacity-0
    ...
    <div className="pointer-events-none absolute inset-0 ring-0 ring-white/0 group-hover:ring-1 group-hover:ring-white/30
